...
public class InputMovie extends JPanel {
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btnAdd && !(tfTitle.getText().equals(""))) {
				...
				lib.addMovie(new Movie(tfTitle.getText(), type, director,
						length, genre, rating));
				clear();
				lib.hideAddMovieFrame();
			} else {
				JOptionPane.showMessageDialog(null,
						"Movie has to have a title!");
			}
		}
	}
	...
	// InputMovie panel = new InputMovie();
